...
public class PatientsFrame extends javax.swing.JFrame {
    ...
    private void populateTable(){
        try{
            ...
            String[][] rows = jdbc.getAllPatients();
            ...
            try{
                ...
                try{
                    ...
                    if(row[0]!=null){
                        ...
                        ageField.setText(row[1]);
                        
                        String fetchedGender = row[2];
                        if(maleButton.getActionCommand().equals(fetchedGender)){
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/patient_icon.png"))); // NOI18N
        ...
        ageField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        maleButton.setForeground(new java.awt.Color(0, 0, 0));
        maleButton.setSelected(true);
        ...
        femaleButton.setForeground(new java.awt.Color(0, 0, 0));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(mobileNoField, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(addressField, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ageField, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        patientTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Age", "Gender", "Address", "Mob.No."
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if(!nameField.getText().equals("") && !ageField.getText().equals("") && !addressField.getText().equals("") && !mobileNoField.getText().equals("")){
            try{
                jdbc.createConnection();
                int id = jdbc.addPatient(nameField.getText(), ageField.getText(), genderField.getSelection().getActionCommand(), addressField.getText(), mobileNoField.getText());
                populateTable();
                JOptionPane.showMessageDialog(this, "Patient added with ID " + id + "!");
            }
            catch(Exception e){
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Something went wrong!");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            if(!idField.getText().equals("")){
                ...
                int userAction = JOptionPane.showConfirmDialog(this, "Do you want to delete patient with ID " + idField.getText() + "?");
                if(userAction==JOptionPane.YES_OPTION){
                    jdbc.createConnection();
                    jdbc.deletePatient(idField.getText());
                    populateTable();
                    JOptionPane.showMessageDialog(this, "Patient with ID " + idField.getText() + " deleted !");
                }
            }
        }
        catch(Exception e){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        try{
            if(!idField.getText().equals("") && !nameField.getText().equals("") && !ageField.getText().equals("") && !addressField.getText().equals("") && !mobileNoField.getText().equals("")){
                
                jdbc.createConnection();
                jdbc.editPatient(idField.getText(), nameField.getText(), ageField.getText(), genderField.getSelection().getActionCommand(), addressField.getText(), mobileNoField.getText());
                populateTable();
                JOptionPane.showMessageDialog(this, "Patient with ID " + idField.getText() + " edited!");
