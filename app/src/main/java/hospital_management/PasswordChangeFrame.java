...
public class PasswordChangeFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!new String(currentPasswordField.getPassword()).equals("") && !new String(newPasswordField.getPassword()).equals("")){
            try{
                jdbc.createConnection();
                if(jdbc.isAdmin(new String(currentPasswordField.getPassword()))){
                    int userAction = JOptionPane.showConfirmDialog(this, "Do you want to change password?");
                    if(userAction==JOptionPane.YES_OPTION){
                        jdbc.changePassword(new String(newPasswordField.getPassword()));
